...
INSERT INTO "Permission" ("roleId", "subject", "action") SELECT "id", 'UserToken', 'create' FROM "Role";
INSERT INTO "Permission" ("roleId", "subject", "action") SELECT "id", 'UserToken', 'delete' FROM "Role";
INSERT INTO "Permission" ("roleId", "subject", "action") SELECT "id", 'UserToken', 'search' FROM "Role";
